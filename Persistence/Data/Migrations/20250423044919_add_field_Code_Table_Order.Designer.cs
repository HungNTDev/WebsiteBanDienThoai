...
namespace Persistence.Data.Migrations
{
    ...
    [Migration("20250423044919_add_field_Code_Table_Order")]
    partial class add_field_Code_Table_Order
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.PaymentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ea7d4939-1c79-4004-9a1a-3a85f2336581"),
                            Code = "CASH",
                            CreatedDate = new DateTime(2025, 4, 23, 11, 49, 18, 828, DateTimeKind.Local).AddTicks(7564),
                            IsActive = true,
                            UpdatedDate = new DateTime(2025, 4, 23, 11, 49, 18, 828, DateTimeKind.Local).AddTicks(7574),
                            Value = "Thanh toán tại cửa hàng"
                        },
                        new
                        {
                            Id = new Guid("899e183e-fd08-42b0-abc2-3339bc4b479c"),
                            Code = "VNPAY",
                            CreatedDate = new DateTime(2025, 4, 23, 11, 49, 18, 828, DateTimeKind.Local).AddTicks(7583),
                            IsActive = true,
                            UpdatedDate = new DateTime(2025, 4, 23, 11, 49, 18, 828, DateTimeKind.Local).AddTicks(7583),
            ...
            modelBuilder.Entity("Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Series", "SeriesName")
                        .WithMany("Products")
